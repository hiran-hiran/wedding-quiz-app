...
export type InsertGuestUserMutationVariables = Exact<{
  name: Scalars['String'];
  seat_no?: Maybe<Scalars['String']>;
  quiz_id: Scalars['uuid'];
}>;
...
export type InsertGuestUserMutation = { __typename?: 'mutation_root', insert_guest_user_one?: Maybe<{ __typename?: 'guest_user', id: any, name: string, quiz_id: any, seat_no?: Maybe<string> }> };

export type UpdateGuestUserMutationVariables = Exact<{
  id: Scalars['uuid'];
  point?: Maybe<Scalars['Int']>;
  q1a?: Maybe<Scalars['String']>;
  q2a?: Maybe<Scalars['String']>;
...
export type UpdateGuestUserMutation = { __typename?: 'mutation_root', update_guest_user_by_pk?: Maybe<{ __typename?: 'guest_user', id: any, name: string, point?: Maybe<number>, q1a?: Maybe<string>, q2a?: Maybe<string>, q3a?: Maybe<string>, q4a?: Maybe<string>, q5a?: Maybe<string>, q6a?: Maybe<string>, q7a?: Maybe<string>, q8a?: Maybe<string>, q9a?: Maybe<string>, q10a?: Maybe<string> }> };
...
export type GetQuizByIdQuery = { __typename?: 'query_root', quiz_by_pk?: Maybe<{ __typename?: 'quiz', id: any, created_at: any, title: string, q1?: Maybe<string>, q1a?: Maybe<string>, q2?: Maybe<string>, q2a?: Maybe<string>, q3?: Maybe<string>, q3a?: Maybe<string>, q4?: Maybe<string>, q4a?: Maybe<string>, q5?: Maybe<string>, q5a?: Maybe<string>, q6?: Maybe<string>, q6a?: Maybe<string>, q7?: Maybe<string>, q7a?: Maybe<string>, q8?: Maybe<string>, q8a?: Maybe<string>, q9?: Maybe<string>, q9a?: Maybe<string>, q10?: Maybe<string>, q10a?: Maybe<string> }> };

export type GetGuestUsersQueryVariables = Exact<{
  quizId: Scalars['uuid'];
}>;


export type GetGuestUsersQuery = { __typename?: 'query_root', guest_user: Array<{ __typename?: 'guest_user', id: any, name: string, quiz_id: any, seat_no?: Maybe<string>, point?: Maybe<number>, q1a?: Maybe<string>, q2a?: Maybe<string>, q3a?: Maybe<string>, q4a?: Maybe<string>, q5a?: Maybe<string>, q6a?: Maybe<string>, q7a?: Maybe<string>, q8a?: Maybe<string>, q9a?: Maybe<string>, q10a?: Maybe<string> }> };

export type GetGuestUserByPkQueryVariables = Exact<{
  id: Scalars['uuid'];
}>;


export type GetGuestUserByPkQuery = { __typename?: 'query_root', guest_user_by_pk?: Maybe<{ __typename?: 'guest_user', id: any, name: string, quiz_id: any, seat_no?: Maybe<string>, point?: Maybe<number>, q1a?: Maybe<string>, q2a?: Maybe<string>, q3a?: Maybe<string>, q4a?: Maybe<string>, q5a?: Maybe<string>, q6a?: Maybe<string>, q7a?: Maybe<string>, q8a?: Maybe<string>, q9a?: Maybe<string>, q10a?: Maybe<string> }> };
...
export const InsertGuestUserDocument = gql`
  ...
  insert_guest_user_one(
    ...
    `;
export type InsertGuestUserMutationFn = Apollo.MutationFunction<InsertGuestUserMutation, InsertGuestUserMutationVariables>;

/**
 * __useInsertGuestUserMutation__
 *
 * To run a mutation, you first call `useInsertGuestUserMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useInsertGuestUserMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [insertGuestUserMutation, { data, loading, error }] = useInsertGuestUserMutation({
 *   variables: {
 *      name: // value for 'name'
 *      seat_no: // value for 'seat_no'
 *      quiz_id: // value for 'quiz_id'
 *   },
 * });
 */
export function useInsertGuestUserMutation(baseOptions?: Apollo.MutationHookOptions<InsertGuestUserMutation, InsertGuestUserMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<InsertGuestUserMutation, InsertGuestUserMutationVariables>(InsertGuestUserDocument, options);
      }
export type InsertGuestUserMutationHookResult = ReturnType<typeof useInsertGuestUserMutation>;
export type InsertGuestUserMutationResult = Apollo.MutationResult<InsertGuestUserMutation>;
export type InsertGuestUserMutationOptions = Apollo.BaseMutationOptions<InsertGuestUserMutation, InsertGuestUserMutationVariables>;
export const UpdateGuestUserDocument = gql`
    mutation updateGuestUser($id: uuid!, $point: Int, $q1a: String, $q2a: String, $q3a: String, $q4a: String, $q5a: String, $q6a: String, $q7a: String, $q8a: String, $q9a: String, $q10a: String) {
  update_guest_user_by_pk(
    pk_columns: {id: $id}
    _set: {q1a: $q1a, q2a: $q2a, q3a: $q3a, q4a: $q4a, q5a: $q5a, q6a: $q6a, q7a: $q7a, q8a: $q8a, q9a: $q9a, q10a: $q10a, point: $point}
  ) {
    id
    name
    point
    ...
    `;
export type UpdateGuestUserMutationFn = Apollo.MutationFunction<UpdateGuestUserMutation, UpdateGuestUserMutationVariables>;

/**
 * __useUpdateGuestUserMutation__
 *
 * To run a mutation, you first call `useUpdateGuestUserMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateGuestUserMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateGuestUserMutation, { data, loading, error }] = useUpdateGuestUserMutation({
 *   variables: {
 *      id: // value for 'id'
 ...
 * });
 */
export function useUpdateGuestUserMutation(baseOptions?: Apollo.MutationHookOptions<UpdateGuestUserMutation, UpdateGuestUserMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateGuestUserMutation, UpdateGuestUserMutationVariables>(UpdateGuestUserDocument, options);
      }
export type UpdateGuestUserMutationHookResult = ReturnType<typeof useUpdateGuestUserMutation>;
export type UpdateGuestUserMutationResult = Apollo.MutationResult<UpdateGuestUserMutation>;
export type UpdateGuestUserMutationOptions = Apollo.BaseMutationOptions<UpdateGuestUserMutation, UpdateGuestUserMutationVariables>;
...
export const GetGuestUsersDocument = gql`
  ...
  guest_user(where: {quiz_id: {_eq: $quizId}}, order_by: {point: desc}) {
    id
    name
    quiz_id
    seat_no
 ...
 * });
 */
export function useGetGuestUsersQuery(baseOptions: Apollo.QueryHookOptions<GetGuestUsersQuery, GetGuestUsersQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetGuestUsersQuery, GetGuestUsersQueryVariables>(GetGuestUsersDocument, options);
      }
export function useGetGuestUsersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetGuestUsersQuery, GetGuestUsersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetGuestUsersQuery, GetGuestUsersQueryVariables>(GetGuestUsersDocument, options);
        }
...
export type GetGuestUsersQueryResult = Apollo.QueryResult<GetGuestUsersQuery, GetGuestUsersQueryVariables>;
export const GetGuestUserByPkDocument = gql`
...
/**
 * __useGetGuestUserByPkQuery__
 *
 * To run a query within a React component, call `useGetGuestUserByPkQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetGuestUserByPkQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetGuestUserByPkQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetGuestUserByPkQuery(baseOptions: Apollo.QueryHookOptions<GetGuestUserByPkQuery, GetGuestUserByPkQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetGuestUserByPkQuery, GetGuestUserByPkQueryVariables>(GetGuestUserByPkDocument, options);
      }
export function useGetGuestUserByPkLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetGuestUserByPkQuery, GetGuestUserByPkQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetGuestUserByPkQuery, GetGuestUserByPkQueryVariables>(GetGuestUserByPkDocument, options);
        }
export type GetGuestUserByPkQueryHookResult = ReturnType<typeof useGetGuestUserByPkQuery>;
export type GetGuestUserByPkLazyQueryHookResult = ReturnType<typeof useGetGuestUserByPkLazyQuery>;
export type GetGuestUserByPkQueryResult = Apollo.QueryResult<GetGuestUserByPkQuery, GetGuestUserByPkQueryVariables>;